  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Courier Outward Entry</h1>
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <input type="text" placeholder="Recipient" className="w-full px-3 py-2 border rounded-lg" value={formData.to} onChange={(e) => setFormData({...formData, to: e.target.value})} />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-semibold text-gray-700 mb-2">Sent By</label>
            <input type="text" placeholder="Sent by" className="w-full px-3 py-2 border rounded-lg" value={formData.sentBy} onChange={(e) => setFormData({...formData, sentBy: e.target.value})} />
          </div>
          <div className="mb-4">
          ...
          <div className="flex gap-3">
            <button className="bg-cyan-500 text-white px-6 py-2 rounded-lg hover:bg-cyan-600">Save Outward</button>
            <button className="bg-white border px-6 py-2 rounded-lg hover:bg-gray-50">Clear</button>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex gap-3 mb-4">
            <input type="text" placeholder="Search outward..." className="px-3 py-2 border rounded" />
